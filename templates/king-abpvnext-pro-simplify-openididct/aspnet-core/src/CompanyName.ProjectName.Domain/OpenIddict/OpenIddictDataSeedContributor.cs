...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _scopeManager.FindByNameAsync("ProjectName") == null)
        {
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            ...
            await CreateApplicationAsync(
                ...
                grantTypes: new List<string>
                {
                    ...
                    VerifyCodeExtensionGrantConsts.VerifyCode
                },
                scopes: commonScopes,
        ...
        {
            var blazorServerTieredRootUrl = configurationSection["ProjectName_BlazorServerTiered:RootUrl"].EnsureEndsWith('/');
        ...
        List<string> permissions = null)
    {
        ...
        if (client == null)
        {
            ...
            foreach (var grantType in grantTypes)
            {
                ...
                if (grantType == VerifyCodeExtensionGrantConsts.VerifyCode)
                {
                    application.Permissions.Add(OpenIddictConstants.Permissions.Prefixes.GrantType + VerifyCodeExtensionGrantConsts.VerifyCode);
                    application.Permissions.Add(OpenIddictConstants.Permissions.Endpoints.Device);
                }
            }

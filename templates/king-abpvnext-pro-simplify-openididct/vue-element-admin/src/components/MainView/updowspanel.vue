...
export default {
  ...
  methods: {
    getAutoHeight() {
      ...
      // this.$nextTick(() => {
      // let height =
      // clas 为up 的clientHeight -  查询card的clientHeight - table上下的padding - 查询card 的padding -app-container 的padding  -减去工具栏的的高度
      // peldvendor.clientHeight - (elup.clientHeight + 22 + 30 + 20 + 60);
      this.$nextTick(() => {
        let height
        height =
          pelpar.offsetHeight -
        ...
        //   height =
        //     pelpar.offsetHeight -
        //     (elup.offsetHeight + vxetoolbar.offsetHeight + 22 + 10);
        // }
        // //vxe-toobar
        // if (this.isvxetoolbar != false) {
        //   height =

<template>
  <div class="drawer-container">
    <div class="setting-drawer-content">
      ...
      <h3 class="drawer-title">{{ $t("IdentityServer['Settings:Title']") }}</h3>
      ...
      <div class="drawer-item">
        <span>{{ $t("IdentityServer['Settings:Theme']") }}</span>
        <theme-picker
      ...
      <div class="drawer-item">
        <span>{{ $t("IdentityServer['Settings:TagsView']") }}</span>
        <el-switch v-model="tagsView" class="drawer-switch" />
      </div>

      <div class="drawer-item">
        <span>{{ $t("IdentityServer['Settings:FixedHeader']") }}</span>
        <el-switch v-model="fixedHeader" class="drawer-switch" />
      </div>

      <div class="drawer-item">
        <span>{{ $t("IdentityServer['Settings:SidebarLogo']") }}</span>

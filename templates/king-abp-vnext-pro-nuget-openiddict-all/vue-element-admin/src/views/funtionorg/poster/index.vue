    ...
    <updowspanel @setTableHeight="setTableHeight">
      <template slot="up">
        <el-form :inline="true" :model="searchform" class="form-inline">
          ...
          <el-form-item>
            <el-button type="primary" v-if="checkPermission('Institution.Poster')" @click="getposterlist">查询</el-button>
          </el-form-item>
          <el-form-item>
      ...
      <template slot="down">
        ...
        >
          ...
          <vxe-table-column title="操作" min-width="200">
            <template v-slot="{ row }">
              <el-button style="color:#409eff" icon="el-icon-edit" type="text" v-if="checkPermission('Institution.Poster.Update')" @click="editposter(row)">编辑</el-button>
              <el-button style="color:#f56c6c" icon="el-icon-delete" type="text" v-if="checkPermission('Institution.Poster.Delete')" @click="deleteposter(row)">删除</el-button>
              <el-button style="color:#67c23a" icon="el-icon-link" type="text" v-if="checkPermission('Institution.Poster.BindUser')" @click="binduser(row)">绑定用户</el-button>
            </template>
          </vxe-table-column>
        </vxe-table>
        <vxe-pager

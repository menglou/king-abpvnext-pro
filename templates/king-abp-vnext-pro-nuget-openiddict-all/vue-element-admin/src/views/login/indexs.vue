  ...
  <div class="login-container">
    ...
    >
      ...
      <div style="text-align: right;">
        <el-button
          v-if="features['Openiddict.SocialLogins'] === 'true'"
          class="thirdparty-button"
          type="primary"
          size="small"
          @click="showDialog = true"
        >
          {{ $t("Openiddict['Login:ThirdParty']") }}
        </el-button>
      </div>
    </el-form>
    ...
    <el-dialog
      :title="$t('Openiddict[\'Login:ThirdParty\']')"
      :visible.sync="showDialog"
    >
      {{ $t("Openiddict['Login:ThirdPartyTips']") }}
      <br>
      <br>
      <br>
    </el-dialog>

  ...
  <div class="login-container">
    ...
    >
      ...
      <div style="text-align: right;">
        <el-button
          v-if="features['IdentityServer.SocialLogins'] === 'true'"
          class="thirdparty-button"
          type="primary"
          size="small"
          @click="showDialog = true"
        >
          {{ $t("IdentityServer['Login:ThirdParty']") }}
        </el-button>
      </div>
    </el-form>
    ...
    <el-dialog
      :title="$t('IdentityServer[\'Login:ThirdParty\']')"
      :visible.sync="showDialog"
    >
      {{ $t("IdentityServer['Login:ThirdPartyTips']") }}
      <br>
      <br>
      <br>
    </el-dialog>

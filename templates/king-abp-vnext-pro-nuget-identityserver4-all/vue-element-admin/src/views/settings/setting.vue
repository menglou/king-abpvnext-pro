          ...
          >
            <el-card class="box-card"  >
              <div slot="header" class="clearfix">
                <span>{{
                  $t(`EasyAbpAbpSettingUi.${card[0].properties.Group2}`)
                }}</span>
              </div>
              <div class="text item">
                <el-form :ref="card[0].properties.Group2" label-position="top">
                  ...
                  <el-button
                    type="primary"
                    @click="
                      updateSettingValues(card[0].properties.Group2, sIndex)
                    "
...
export default {
  ...
  methods: {
    ...
    updateSettingValues(formName, index) {
      ...
      //判断object 中的是否有布尔值 如果有就转成string

  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      <template v-if="device !== 'mobile'">
        ...
        <el-tooltip
          :content="$t('IdentityServer[\'Navbar:Size\']')"
          effect="dark"
          placement="bottom"
        >
      ...
      <!-- 通知 -->
      <div class="right-menu-item hover-effect" v-if="device !== 'mobile'">
        <el-popover
          placement="bottom"
          trigger="click"
      ...
      >
        ...
        <el-dropdown-menu slot="dropdown">
          <router-link to="/profile/index">
            <el-dropdown-item>
              {{ $t("IdentityServer['Navbar:Profile']") }}
            </el-dropdown-item>
          </router-link>
          <router-link to="/">
            <el-dropdown-item>
              {{ $t("IdentityServer['Navbar:Dashboard']") }}
            </el-dropdown-item>
          </router-link>
          <el-dropdown-item divided @click.native="logout">
            <span style="display: block">{{
              $t("IdentityServer['Navbar:LogOut']")
            }}</span>
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>

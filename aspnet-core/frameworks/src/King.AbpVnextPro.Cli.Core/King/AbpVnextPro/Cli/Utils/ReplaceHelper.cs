...
public static class ReplaceHelper
{
        ...
        string version)
    {
        var result = content.ReplacePackageReferenceBasicManagement()
            ...
            .ReplacePackageReferenceScheduleTaskManagement()
            .ReplacePackageReferencePayCenterManagement()
            .ReplacePackageReferenceInstitutionManagement()
            .ReplacePackageReferenceCore()
            .ReplaceKingPackageVersion(version);

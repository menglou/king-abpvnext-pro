...
public class AbpVnextProCapDistributedEventBus : EventBusBase, IDistributedEventBus, ISingletonDependency
{
    ...
    public AbpVnextProCapDistributedEventBus(IServiceScopeFactory serviceScopeFactory,
        ...
        bool useOutbox = true)
    {
        ...
        {
            if (UnitOfWorkManager.Current is not AbpVnextProCapUnitOfWork capUnitOfWork || capUnitOfWork.CapTransaction is null)
            {

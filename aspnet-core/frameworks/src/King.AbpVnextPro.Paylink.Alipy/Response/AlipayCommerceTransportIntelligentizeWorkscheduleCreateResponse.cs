...
{
    /// <summary>
    /// AlipayCommerceTransportIntelligentizeWorkscheduleCreateResponse.
    /// </summary>
    public class AlipayCommerceTransportIntelligentizeWorkscheduleCreateResponse : AlipayResponse
    {
        /// <summary>
        /// 扩展信息，json格式，由双方约定取值
        /// </summary>

...
{
    /// <summary>
    /// alipay.ebpp.invoice.enterpriseconsume.detail.query
    /// </summary>
    public class AlipayEbppInvoiceEnterpriseconsumeDetailQueryRequest : IAlipayRequest<AlipayEbppInvoiceEnterpriseconsumeDetailQueryResponse>
    {
        /// <summary>
        /// 凭证详情查询接口
        /// </summary>

...
{
    /// <summary>
    /// alipay.commerce.gas.info.groupcoupon.query
    /// </summary>
    public class AlipayCommerceGasInfoGroupcouponQueryRequest : IAlipayRequest<AlipayCommerceGasInfoGroupcouponQueryResponse>
    {
        /// <summary>

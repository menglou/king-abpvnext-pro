...
{
    /// <summary>
    /// alipay.open.app.openbizmock.openidnonstand.query
    /// </summary>
    public class AlipayOpenAppOpenbizmockOpenidnonstandQueryRequest : IAlipayRequest<AlipayOpenAppOpenbizmockOpenidnonstandQueryResponse>
    {
        /// <summary>
        /// 非标准输入输出openid接口
        /// </summary>

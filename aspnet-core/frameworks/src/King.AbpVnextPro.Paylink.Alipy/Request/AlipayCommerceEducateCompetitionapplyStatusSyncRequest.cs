...
{
    /// <summary>
    /// alipay.commerce.educate.competitionapply.status.sync
    /// </summary>
    public class AlipayCommerceEducateCompetitionapplyStatusSyncRequest : IAlipayRequest<AlipayCommerceEducateCompetitionapplyStatusSyncResponse>
    {
        /// <summary>
        /// 赛事报名状态同步接口
        /// </summary>

...
{
    /// <summary>
    /// alipay.commerce.medical.card.auth.query
    /// </summary>
    public class AlipayCommerceMedicalCardAuthQueryRequest : IAlipayRequest<AlipayCommerceMedicalCardAuthQueryResponse>
    {
        /// <summary>

...
{
    /// <summary>
    /// alipay.pcredit.huabei.auth.refund.apply
    /// </summary>
    public class AlipayPcreditHuabeiAuthRefundApplyRequest : IAlipayRequest<AlipayPcreditHuabeiAuthRefundApplyResponse>
    {
        /// <summary>
        /// 花芝结算扣款费用逆向退款申请
        /// </summary>

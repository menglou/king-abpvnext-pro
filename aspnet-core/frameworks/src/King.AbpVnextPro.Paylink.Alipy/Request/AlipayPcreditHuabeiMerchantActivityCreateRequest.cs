...
{
    /// <summary>
    /// alipay.pcredit.huabei.merchant.activity.create
    /// </summary>
    public class AlipayPcreditHuabeiMerchantActivityCreateRequest : IAlipayRequest<AlipayPcreditHuabeiMerchantActivityCreateResponse>
    {
        /// <summary>
        /// 新版花呗分期商家贴息活动创建接口
        /// </summary>

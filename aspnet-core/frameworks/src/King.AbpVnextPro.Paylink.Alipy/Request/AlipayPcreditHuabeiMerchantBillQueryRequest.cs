...
{
    /// <summary>
    /// alipay.pcredit.huabei.merchant.bill.query
    /// </summary>
    public class AlipayPcreditHuabeiMerchantBillQueryRequest : IAlipayRequest<AlipayPcreditHuabeiMerchantBillQueryResponse>
    {
        /// <summary>
        /// 花呗分期商户贴息优惠账单查询
        /// </summary>

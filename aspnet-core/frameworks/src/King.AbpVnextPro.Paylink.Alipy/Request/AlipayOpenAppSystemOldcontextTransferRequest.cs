...
{
    /// <summary>
    /// alipay.open.app.system.oldcontext.transfer
    /// </summary>
    public class AlipayOpenAppSystemOldcontextTransferRequest : IAlipayRequest<AlipayOpenAppSystemOldcontextTransferResponse>
    {
        /// <summary>

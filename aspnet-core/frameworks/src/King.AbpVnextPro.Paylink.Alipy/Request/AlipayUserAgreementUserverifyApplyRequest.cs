...
{
    /// <summary>
    /// alipay.user.agreement.userverify.apply
    /// </summary>
    public class AlipayUserAgreementUserverifyApplyRequest : IAlipayRequest<AlipayUserAgreementUserverifyApplyResponse>
    {
        /// <summary>
        /// 协议用户一致性验证
        /// </summary>

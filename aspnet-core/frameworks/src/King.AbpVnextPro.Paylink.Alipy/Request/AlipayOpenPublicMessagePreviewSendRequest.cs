...
{
    /// <summary>
    /// alipay.open.public.message.preview.send
    /// </summary>
    public class AlipayOpenPublicMessagePreviewSendRequest : IAlipayRequest<AlipayOpenPublicMessagePreviewSendResponse>
    {
        /// <summary>
        /// 预览消息发送接口
        /// </summary>

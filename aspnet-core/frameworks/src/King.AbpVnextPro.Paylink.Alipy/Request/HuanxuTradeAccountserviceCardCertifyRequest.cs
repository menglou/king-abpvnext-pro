...
{
    /// <summary>
    /// huanxu.trade.accountservice.card.certify
    /// </summary>
    public class HuanxuTradeAccountserviceCardCertifyRequest : IAlipayRequest<HuanxuTradeAccountserviceCardCertifyResponse>
    {
        /// <summary>
        /// 银行卡认证接口
        /// </summary>

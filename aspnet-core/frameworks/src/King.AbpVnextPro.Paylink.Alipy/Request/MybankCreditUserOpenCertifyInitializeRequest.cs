...
{
    /// <summary>
    /// mybank.credit.user.open.certify.initialize
    /// </summary>
    public class MybankCreditUserOpenCertifyInitializeRequest : IAlipayRequest<MybankCreditUserOpenCertifyInitializeResponse>
    {
        /// <summary>
        /// 用户身份认证初始化
        /// </summary>

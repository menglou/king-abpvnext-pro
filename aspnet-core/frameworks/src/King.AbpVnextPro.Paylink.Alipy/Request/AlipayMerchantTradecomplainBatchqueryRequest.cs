...
{
    /// <summary>
    /// alipay.merchant.tradecomplain.batchquery
    /// </summary>
    public class AlipayMerchantTradecomplainBatchqueryRequest : IAlipayRequest<AlipayMerchantTradecomplainBatchqueryResponse>
    {
        /// <summary>
        /// 查询交易投诉列表
        /// </summary>

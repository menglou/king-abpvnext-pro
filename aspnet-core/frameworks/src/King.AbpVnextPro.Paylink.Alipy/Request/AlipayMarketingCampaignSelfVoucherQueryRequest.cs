...
{
    /// <summary>
    /// alipay.marketing.campaign.self.voucher.query
    /// </summary>
    public class AlipayMarketingCampaignSelfVoucherQueryRequest : IAlipayRequest<AlipayMarketingCampaignSelfVoucherQueryResponse>
    {
        /// <summary>
        /// 支付宝商户券信息查询
        /// </summary>

...
{
    /// <summary>
    /// alipay.account.cashpool.allocaterule.create
    /// </summary>
    public class AlipayAccountCashpoolAllocateruleCreateRequest : IAlipayRequest<AlipayAccountCashpoolAllocateruleCreateResponse>
    {
        /// <summary>
        /// 资金池调拨规则新增
        /// </summary>

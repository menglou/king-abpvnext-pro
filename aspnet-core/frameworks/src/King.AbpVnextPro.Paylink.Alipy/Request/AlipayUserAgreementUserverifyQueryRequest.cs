...
{
    /// <summary>
    /// alipay.user.agreement.userverify.query
    /// </summary>
    public class AlipayUserAgreementUserverifyQueryRequest : IAlipayRequest<AlipayUserAgreementUserverifyQueryResponse>
    {
        /// <summary>
        /// 用户协议鉴权查询结果
        /// </summary>

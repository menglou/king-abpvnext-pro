...
{
    /// <summary>
    /// alipay.data.dataservice.ad.promotepagestatistic.query
    /// </summary>
    public class AlipayDataDataserviceAdPromotepagestatisticQueryRequest : IAlipayRequest<AlipayDataDataserviceAdPromotepagestatisticQueryResponse>
    {
        /// <summary>
        /// 查询留资页统计信息
        /// </summary>

...
{
    /// <summary>
    /// alipay.open.app.openbizmock.desensitive.query
    /// </summary>
    public class AlipayOpenAppOpenbizmockDesensitiveQueryRequest : IAlipayRequest<AlipayOpenAppOpenbizmockDesensitiveQueryResponse>
    {

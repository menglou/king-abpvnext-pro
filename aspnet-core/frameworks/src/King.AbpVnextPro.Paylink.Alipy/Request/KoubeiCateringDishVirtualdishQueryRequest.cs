...
{
    /// <summary>
    /// koubei.catering.dish.virtualdish.query
    /// </summary>
    public class KoubeiCateringDishVirtualdishQueryRequest : IAlipayRequest<KoubeiCateringDishVirtualdishQueryResponse>
    {
        /// <summary>
        /// 口碑菜品虚拟类目菜品查询
        /// </summary>

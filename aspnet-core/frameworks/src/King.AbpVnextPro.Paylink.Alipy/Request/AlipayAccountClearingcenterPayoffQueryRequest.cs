...
{
    /// <summary>
    /// alipay.account.clearingcenter.payoff.query
    /// </summary>
    public class AlipayAccountClearingcenterPayoffQueryRequest : IAlipayRequest<AlipayAccountClearingcenterPayoffQueryResponse>
    {
        /// <summary>
        /// 查询解付登记薄信息
        /// </summary>

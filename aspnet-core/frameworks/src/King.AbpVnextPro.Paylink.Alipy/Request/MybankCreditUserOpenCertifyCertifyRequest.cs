...
{
    /// <summary>
    /// mybank.credit.user.open.certify.certify
    /// </summary>
    public class MybankCreditUserOpenCertifyCertifyRequest : IAlipayRequest<MybankCreditUserOpenCertifyCertifyResponse>
    {
        /// <summary>
        /// 用户身份认证开始认证
        /// </summary>

...
{
    /// <summary>
    /// alipay.commerce.educate.info.participant.certify
    /// </summary>
    public class AlipayCommerceEducateInfoParticipantCertifyRequest : IAlipayRequest<AlipayCommerceEducateInfoParticipantCertifyResponse>
    {
        /// <summary>
        /// 参赛者信息校验接口
        /// </summary>

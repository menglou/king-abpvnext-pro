...
{
    /// <summary>
    /// alipay.open.app.openbizmock.apisdkgray.query
    /// </summary>
    public class AlipayOpenAppOpenbizmockApisdkgrayQueryRequest : IAlipayRequest<AlipayOpenAppOpenbizmockApisdkgrayQueryResponse>
    {
        /// <summary>
        /// 灰度组件SDK线上验证测试接口
        /// </summary>

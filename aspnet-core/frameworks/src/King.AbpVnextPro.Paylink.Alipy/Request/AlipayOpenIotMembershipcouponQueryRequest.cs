...
{
    /// <summary>
    /// alipay.open.iot.membershipcoupon.query
    /// </summary>
    public class AlipayOpenIotMembershipcouponQueryRequest : IAlipayRequest<AlipayOpenIotMembershipcouponQueryResponse>
    {
        /// <summary>

...
{
    /// <summary>
    /// alipay.commerce.transport.intelligentize.data.sync
    /// </summary>
    public class AlipayCommerceTransportIntelligentizeDataSyncRequest : IAlipayRequest<AlipayCommerceTransportIntelligentizeDataSyncResponse>
    {
        /// <summary>
        /// 大出行智能平台-出行数据-同步
        /// </summary>

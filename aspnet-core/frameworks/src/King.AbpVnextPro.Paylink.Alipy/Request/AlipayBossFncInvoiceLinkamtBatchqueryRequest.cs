...
{
    /// <summary>
    /// alipay.boss.fnc.invoice.linkamt.batchquery
    /// </summary>
    public class AlipayBossFncInvoiceLinkamtBatchqueryRequest : IAlipayRequest<AlipayBossFncInvoiceLinkamtBatchqueryResponse>
    {
        /// <summary>

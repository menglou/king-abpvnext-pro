...
{
    /// <summary>
    /// alipay.open.app.appcontent.item.batchquery
    /// </summary>
    public class AlipayOpenAppAppcontentItemBatchqueryRequest : IAlipayRequest<AlipayOpenAppAppcontentItemBatchqueryResponse>
    {
        /// <summary>
        /// 应用内容商品批量查询
        /// </summary>

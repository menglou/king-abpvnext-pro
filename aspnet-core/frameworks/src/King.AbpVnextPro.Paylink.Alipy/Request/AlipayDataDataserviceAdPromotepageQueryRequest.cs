...
{
    /// <summary>
    /// alipay.data.dataservice.ad.promotepage.query
    /// </summary>
    public class AlipayDataDataserviceAdPromotepageQueryRequest : IAlipayRequest<AlipayDataDataserviceAdPromotepageQueryResponse>
    {
        /// <summary>
        /// 查询留资页列表
        /// </summary>

...
{
    /// <summary>
    /// alipay.commerce.educate.campuscard.authorized.query
    /// </summary>
    public class AlipayCommerceEducateCampuscardAuthorizedQueryRequest : IAlipayRequest<AlipayCommerceEducateCampuscardAuthorizedQueryResponse>
    {

...
{
    /// <summary>
    /// mybank.credit.sceneprod.inst.auth.consult
    /// </summary>
    public class MybankCreditSceneprodInstAuthConsultRequest : IAlipayRequest<MybankCreditSceneprodInstAuthConsultResponse>
    {
        /// <summary>
        /// 机构准入咨询接口
        /// </summary>
